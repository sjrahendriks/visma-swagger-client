...
class CountriesV2Api
{
     ...
     * @return \Swagger\Client\Model\PaginatedResponseCountryApi
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\PaginatedResponseCountryApi, HTTP status code, HTTP response headers (array of strings)
     */
    public function countriesV2GetWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\PaginatedResponseCountryApi';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\PaginatedResponseCountryApi',
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\CountryApi
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\CountryApi, HTTP status code, HTTP response headers (array of strings)
     */
    public function countriesV2Get_0WithHttpInfo($countrycode)
    {
        $returnType = '\Swagger\Client\Model\CountryApi';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\CountryApi',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
