...
class TermsOfPaymentV2Api
{
     ...
     * @return \Swagger\Client\Model\PaginatedResponseTermsOfPaymentApi
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\PaginatedResponseTermsOfPaymentApi, HTTP status code, HTTP response headers (array of strings)
     */
    public function termsOfPaymentV2GetWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\PaginatedResponseTermsOfPaymentApi';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\PaginatedResponseTermsOfPaymentApi',
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\TermsOfPaymentApi, HTTP status code, HTTP response headers (array of strings)
     */
    public function termsOfPaymentV2Get_0WithHttpInfo($id)
    {
        $returnType = '\Swagger\Client\Model\TermsOfPaymentApi';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\TermsOfPaymentApi',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
