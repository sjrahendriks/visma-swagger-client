...
class UsersV2Api
{
     ...
     * @return \Swagger\Client\Model\PaginatedResponseUserApi
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\PaginatedResponseUserApi, HTTP status code, HTTP response headers (array of strings)
     */
    public function usersV2GetWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\PaginatedResponseUserApi';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\PaginatedResponseUserApi',
