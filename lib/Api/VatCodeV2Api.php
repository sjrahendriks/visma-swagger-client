...
class VatCodeV2Api
{
     ...
     * @return \Swagger\Client\Model\PaginatedResponseVatCodeApi
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\PaginatedResponseVatCodeApi, HTTP status code, HTTP response headers (array of strings)
     */
    public function vatCodeV2GetWithHttpInfo($vat_rate_date = null)
    {
        $returnType = '\Swagger\Client\Model\PaginatedResponseVatCodeApi';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\PaginatedResponseVatCodeApi',
