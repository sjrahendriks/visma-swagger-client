...
'terms_of_payment' => '\Swagger\Client\Model\TermsOfPaymentApi',
'sales_document_attachments' => 'string[]',
'rows' => '\Swagger\Client\Model\QuoteRowApi[]',
'total_amount' => 'double',
'vat_amount' => 'double',
...
self::ROT_REDUCED_INVOICING_TYPE_2,        ];
     ...
     * Sets persons
     *
     * @param \Swagger\Client\Model\SalesDocumentRotRutReductionPersonApi[] $persons Only available for ROT/RUT or Green Technology
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\TermsOfPaymentApi
     */
     ...
     *
     * @param \Swagger\Client\Model\TermsOfPaymentApi $terms_of_payment terms_of_payment
     *
     * @return $this
     */
     ...
     * Gets rows
     *
     * @return \Swagger\Client\Model\QuoteRowApi[]
     */
     ...
     * Sets rows
     *
     * @param \Swagger\Client\Model\QuoteRowApi[] $rows rows
     *
     * @return $this
     */
