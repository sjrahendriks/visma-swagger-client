...
'voucher_id' => 'string',
'total_amount' => 'double',
'approval_events_history' => '\Swagger\Client\Model\DocumentApprovalEventApi[]'    ];
...
self::DOCUMENT_APPROVAL_STATUS_3,        ];
     ...
     *
     * @return \Swagger\Client\Model\DocumentApprovalEventApi[]
     */
     ...
     *
     * @param \Swagger\Client\Model\DocumentApprovalEventApi[] $approval_events_history The history of approval events of the vat report.
     *
     * @return $this
     */
